...
export class ClassGroupService {
    ...
    public update(classGroupId: string, classGroup: ClassGroup): Observable<Response<ClassGroup>> {
        return this.http.put<Response<ClassGroup>>(`${this.baseUrl}/ClassGroup/Update/${classGroupId}`, classGroup)
            .pipe(catchError(err => {
                throw err;
            }))
    }
